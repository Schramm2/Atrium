...
Use [AGENTS.md](AGENTS.md) for shared repository guidance. This file adds Claude Code-specific project context.
...
- **Production (macOS)**: `~/Library/Application Support/com.ubundi.meet/models/`
- **Production (Windows)**: `%APPDATA%\com.ubundi.meet\models\`

...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            database::speaker_alias_commands::api_list_speaker_aliases,
            database::speaker_alias_commands::api_get_speaker_alias,
            database::speaker_alias_commands::api_save_speaker_alias,
            database::speaker_alias_commands::api_clear_speaker_alias,

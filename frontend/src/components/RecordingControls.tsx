  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col space-y-2">
        <div className="ubundi-recording-dock">
              ...
              {showPlayback ? (
                <>
                  <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-[#2F3498] rounded-full text-white hover:bg-[#1B1F44] transition-colors"
                  >
                    <Mic size={16} />
                  </button>
                ...
                <>
                      ...
                      <TooltipTrigger asChild>
                        <button
                          ...
                          disabled={isStarting || isProcessing || isRecordingDisabled || isValidatingModel}
                            className={`w-12 h-12 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel ? 'bg-gray-400' : 'bg-[#2F3498] hover:bg-[#1B1F44]'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isStopping || isPausing || isResuming ? 'bg-gray-400' : 'bg-[#D77A85] hover:bg-[#C66A75]'
                              } rounded-full text-white transition-colors relative`}
                          >
                            <Square size={16} />
                            {isStopping && (
                  ...
                  <div className="flex items-center space-x-1 mx-4">
                    {barHeights.map((height, index) => (
                      <div
                        key={index}
                        className={`w-1 rounded-full transition-all duration-200 ${isPaused ? 'bg-[#F3C57A]' : 'bg-[#D77A85]'
                          }`}
                        style={{

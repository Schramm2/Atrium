...
if (-not (Test-Path "whisper-server-package\whisper-server.exe")) {
    ...
    try {
        ...
        $downloadUrl = "https://github.com/Schramm2/meetily/releases/download/$tagName/whisper-server.exe"
        ...
        try {
            ...
            if ($releases.Count -gt 0) {
                ...
                $altDownloadUrl = "https://github.com/Schramm2/meetily/releases/download/$latestTag/whisper-server.exe"
            ...
            Write-Host "https://github.com/Schramm2/meetily/releases"

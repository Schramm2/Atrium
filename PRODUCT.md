...
- The release candidate is the native Swift 6.1 and SwiftUI application in `macos/`.
...
- Native product behavior and compatibility are documented in `docs/architecture.md` and `docs/SWIFT_MIGRATION.md`.

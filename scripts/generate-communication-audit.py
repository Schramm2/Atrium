...
REWRITES = [
    ...
    ("macos/Sources/Atrium/Support/UpdaterService.swift", "user", "update status", "check or install update", "authenticated GitHub CLI | Checking GitHub Releases | Schramm2/notive | disk image | Atrium.app", "Update implementation and repository details leaked into user copy.", "Plain update status with an internet or retry next step"),

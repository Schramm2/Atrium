...
console.log(`GitHub Repository: Schramm2/meetily`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/Schramm2/meetily/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/Schramm2/meetily/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/Schramm2/meetily/releases/latest/download/latest.json`);

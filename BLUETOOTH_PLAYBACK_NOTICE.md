...
1. **Notive records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Notive recordings** - Use wired/speakers instead
...
### This is Not a Notive Bug

The issue is in **macOS's Bluetooth audio stack**, not in Notive's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Notive bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Notive now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Notive v0.5.0+ on macOS

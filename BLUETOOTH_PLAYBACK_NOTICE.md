...
When **reviewing recordings** in Ubundi Meet, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Ubundi Meet records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Ubundi Meet recordings** - Use wired/speakers instead
...
### This is Not a Ubundi Meet Bug

The issue is in **macOS's Bluetooth audio stack**, not in Ubundi Meet's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Ubundi Meet bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Ubundi Meet now shows a warning when Bluetooth headphones are active during playback.

        ...
        Button(action: action) {
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text(theme.title)
                        .font(.headline)
                    Text(theme.appearanceDetailLabel)
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
                Spacer()
...
private struct SummarySettingsView: View {
            ...
            Section("Model") {
                ...
                Button("Save model settings") {
                    do {
                        ...
                        saveMessage = "Atrium could not save the model settings. Check the values and try again."
                    }
                }
                if let saveMessage {
                    Text(saveMessage)
    ...
    private func loadModels() async {
        ...
        do {
            ...
            modelActionMessage = "Atrium could not load models. Check the service address and try again."
        }
    }
    ...
    private func pullOllamaModel() async {
        ...
        do {
            ...
            modelActionMessage = "Atrium could not download the model. Check the service address and try again."
        }
    }
    ...
    private func deleteOllamaModel(name: String) async {
        ...
        do {
            ...
            modelActionMessage = "Atrium could not delete the model. Check the service address and try again."
        }
    }
}
